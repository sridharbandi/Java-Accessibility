...
<div class="row">
    ...
    <div class="col-lg-6 col-md-6">
        <h6 class="text-info"><i class="fas fa-arrows-alt text-warning"></i><span
                    class="text-warning"> Browser size</span> : ${browsersize}</h6>
        <hr/>
    </div>
</div>
<div class="row">
...
<div class="row">
    <div class="col-lg-4 col-md-4 pillspage badge badge-danger">
        <div class="section">
            <h6>Errors</h6>
            <h1> ${errorcount}</h1>
        </div>
    </div>
    <div class="col-lg-4 col-md-4 pillspage badge badge-warning">
        <div class="section">
            <h6>Warnings</h6>
            <h1> ${warningcount}</h1>
        </div>
    </div>
    <div class="col-lg-4 col-md-4 pillspage badge badge-info">
        <div class="section ">
            <h6>Notices</h6>
            <h1> ${noticecount}</h1>
        </div>
